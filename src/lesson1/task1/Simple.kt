 ...
 */
fun angleInRadian(deg: Int, min: Int, sec: Int) = (deg + (min.toDouble() / 60) + (sec.toDouble() / 3600)) * PI / 180
 ...
 */
fun accountInThreeYears(initial: Int, percent: Int): Double = initial * (1.0 + percent.toDouble() / 100).pow(3)
